function [x,y,u,v,SnR,Pkh]=multipass(im1,im2,winsize,Dt,overlap,sensit,maske)

% function [x,y,u,v,snr,pkh]=multipass(im1,im2,winsize,time,overlap,sensit,maske)
%
